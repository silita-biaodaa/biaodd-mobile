    ...
    <div class="prise">
        ...
        <div  class="prise-name" v-show="detail.acreage" > 
         ...
         <div  class="prise-name"  > 
            ...
            <div  class="prise-right" >
               <span v-for="(el,i) in detail.unitOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.unitOrg.length -1" class="p-color" >,</i>&nbsp</span>
            </div>
         </div>
        ...
        <div  class="prise-name"  v-show="detail.buildOrg"  > 
            ...
            <div  class="prise-right" >
               <span v-for="(el,i) in detail.buildOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.buildOrg.length -1" >,</i>&nbsp</span>
            </div>
         </div>
          ...
          <div  class="prise-name"  v-show="detail.superOrg" > 
            ...
            <div  class="prise-right" >
                <span v-for="(el,i) in detail.superOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.superOrg.length -1"  >,</i>&nbsp</span>
            </div>
         </div>
         ...
         <div  class="prise-name"  v-show="detail.superPerson" > 
          ...
          <div  class="prise-name"  v-show="detail.exploreOrg" > 
            ...
            <div  class="prise-right" >
              <span v-for="(el,i) in detail.exploreOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.exploreOrg.length -1" >,</i>&nbsp</span>
            </div>
         </div>
          ...
          <div  class="prise-name"   v-show="detail.designOrg"> 
            ...
            <div  class="prise-right" >
               <span v-for="(el,i) in detail.designOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.designOrg.length -1"  >,</i>&nbsp</span>
            </div>
         </div>
          ...
          <div  class="prise-name"  v-show="detail.checkOrg"> 
            ...
            <div  class="prise-right" >
               <span v-for="(el,i) in detail.checkOrg"  :key="i" class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.checkOrg.length -1"  >,</i>&nbsp</span>
            </div>
         </div>
          ...
          <div  class="prise-name"  v-show="detail.joinOrg"> 
            ...
            <div  class="prise-right" >
               <span v-for="(el,i) in detail.joinOrg"  :key="i"  @click.stop="letter(el)"  class="color" >{{el.comName}}&nbsp<i v-show="i !=  detail.joinOrg.length -1" >,</i>&nbsp</span>
            </div>
         </div>
